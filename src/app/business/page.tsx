    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              { title: 'General Liability', desc: 'Protect against third-party claims' },
              { title: 'Property Insurance', desc: 'Cover your business assets' },
              { title: 'Workers Compensation', desc: 'Required coverage for employees' },
              { title: 'Professional Liability', desc: 'Errors & omissions protection' },
              { title: 'Commercial Auto', desc: 'Vehicle coverage for your fleet' },
              { title: 'Cyber Liability', desc: 'Digital security protection' },
            ].map((item) => (
      ...
      <section className="py-16 bg-secondary/50">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-muted-foreground mb-8">Get a custom quote in minutes</p>
