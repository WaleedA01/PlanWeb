    ...
    <footer className="relative mt-20 backdrop-blur-md bg-secondary/95 text-white border-t border-primary/20">
      ...
      <div className="container mx-auto px-4 py-12 relative">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <div className="flex gap-4 mt-4">
              <a href="#" className="text-gray-300 hover:text-primary transition-colors hover:scale-110 transform">
        ...
        <div className="border-t border-primary/20 mt-8 pt-8 text-center text-sm text-gray-400">
          <p>&copy; {new Date().getFullYear()} PlanLife. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
