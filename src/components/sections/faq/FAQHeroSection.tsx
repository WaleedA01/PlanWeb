export default function FAQHeroSection() {
  return (
    <section className="relative min-h-[60vh] flex items-center overflow-hidden bg-gradient-to-br from-[#0da9e4] via-[#3db8e8] to-[#7dd3f0]">
      ...
      <div className="container mx-auto px-4 relative z-10 text-center py-20">
        <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold text-white mb-6 opacity-0 animate-[fadeInUp_0.8s_ease-out_0.2s_forwards]">
          Frequently Asked <span className="text-secondary underline decoration-4 underline-offset-8">Questions.</span>
        </h1>
